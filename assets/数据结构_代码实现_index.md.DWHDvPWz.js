import{_ as s,o as a,c as p,ag as e}from"./chunks/framework.CAXxHpAX.js";const m=JSON.parse('{"title":"408 数据结构 —— 代码实现总览","description":"","frontmatter":{},"headers":[],"relativePath":"数据结构/代码实现/index.md","filePath":"数据结构/代码实现/index.md","lastUpdated":1777124994000}'),l={name:"数据结构/代码实现/index.md"};function r(i,n,c,t,o,b){return a(),p("div",null,[...n[0]||(n[0]=[e(`<h1 id="_408-数据结构-——-代码实现总览" tabindex="-1">408 数据结构 —— 代码实现总览 <a class="header-anchor" href="#_408-数据结构-——-代码实现总览" aria-label="Permalink to &quot;408 数据结构 —— 代码实现总览&quot;">​</a></h1><p>本目录是 408 考研《数据结构》全部代码题覆盖的弹药库，按照<strong>用途</strong>与<strong>语言</strong>划分为 4 个子目录。</p><hr><h2 id="目录结构" tabindex="-1">目录结构 <a class="header-anchor" href="#目录结构" aria-label="Permalink to &quot;目录结构&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span></span></span>
