    ...
    sidebar: {
      '/数据结构/': [
        ...
        },
        {
          ...
          collapsed: true,
          items: [
            { text: '总览', link: '/数据结构/代码实现/' },
            { text: '代码题解题套路', link: '/数据结构/代码实现/代码题' },
            { text: '伪代码版 · C', link: '/数据结构/代码实现/伪代码版本/c版本/' },
            { text: '伪代码版 · C++', link: '/数据结构/代码实现/伪代码版本/c++版本/' },
            { text: '可运行版 · C', link: '/数据结构/代码实现/可运行版本/c版本/' },
            { text: '可运行版 · C++', link: '/数据结构/代码实现/可运行版本/c++版本/' }
          ]
        }
      ],
      '/计算机组成原理/': [
