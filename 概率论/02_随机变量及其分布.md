...
由于 $\forall x_1,x_2\in \mathbb{R},P\{x_1<X\le x_2\}=P\{X\le x_2\}-P\{X\le x_1\}=F(x_2)-F(x_1)$
...
$$
\forall x\in\mathbb{R},F(x)=\int_{-\infty}^xf(t)\mathrm dt
$$
...
- $\forall x_1,x_2\in\mathbb{R} (x_1\le x_2),P\{x_1<x\le x_2\}=F(x_2)-F(x_1)=\int_{x_1}^{x_2}f(x)\mathrm dx$
